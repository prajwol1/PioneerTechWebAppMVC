    ...
    public class ProjectController : Controller
    {
        ...
        public ActionResult SaveData(FormCollection collection)
        {
            try
            {
                ...
                UpdateModel(projectDetail);
                string returnValue = employeeDataAccessLayerObject.SaveEmployeeProjectDetails(projectDetail);
